...
let InsertColBefore = ({ size, color, ...rest }) => {
  return (
...
InsertColBefore.defaultProps = {
  size: 18,
};

InsertColBefore = React.memo ? React.memo(InsertColBefore) : InsertColBefore;

export default InsertColBefore;
