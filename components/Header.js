...
import { getStatusBarHeight, withTheme } from 'react-native-elements/src/config';
import { renderNode, nodeType, ImageSourceType } from 'react-native-elements/src/helpers';
  ...
  render() {
    ...
    return (
      <ViewComponent
        ...
        {...linearGradientProps}
      >
        {/* <StatusBar barStyle={barStyle} translucent {...statusBarProps} /> */}
        <Children
          style={StyleSheet.flatten([
