export default {
  ...
  vipExpiredTime: 'VIP Service will expired at %{time}',
  ...
  settingLabelMdMode: 'Markdown Mode',
  ...
  settingLabelStartLayout: 'Start Layout',
  settingLabelNoteListSort: 'Note List Sort',
  settingLabelFocusModeTimeout: 'Focus Mode Timeout',
  settingLabelFocusModeWithTypewriter: 'Open focus mode with typewriter mode',
  settingLabelLayoutAll: 'Sidebar、Note List and Note',
  settingLabelLayoutNoteListAndNote: 'Note List and Note',
  settingLabelLayoutCreated: 'Created',
  settingLabelLayoutModify: 'Modify',
